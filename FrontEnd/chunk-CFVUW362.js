...
// src/app/pages/reportes/reporte-solicitudes/reporte-solicitudes/reporte-solicitudes.component.ts
var _c0 = (a0, a1) => ({ "bg-green-700": a0, "bg-credigray-100": a1 });
function ReporteSolicitudesComponent_ng_container_14_mat_option_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ReporteSolicitudesComponent_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ReporteSolicitudesComponent_ng_container_14_mat_option_1_Template, 2, 2, "mat-option", 21);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const detalleSolicitudes_r3 = ctx.ngIf;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", detalleSolicitudes_r3.data);
  }
}
function ReporteSolicitudesComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
...
function ReporteSolicitudesComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
...
var _ReporteSolicitudesComponent = class _ReporteSolicitudesComponent {
  constructor() {
    this.searchTerm = "";
    ...
    this.tipoSolicitudesService = inject(TipoSolicitudesService);
    this.currencyPipe = inject(CurrencyPipe);
    this.exportData = [];
    this.fuseService = inject(FuseConfirmationService);
    this.columns = ["N\xFAmero de solicitud", "Fecha de solicitud", "Cupo", "Trabajador", "Identificaci\xF3n", "Salario devengado", "Inicio de contrato", "Fin de contrato", "Empresa", "Tipo de solicitud"];
    this.columnPropertyMap = {
      "N\xFAmero de solicitud": "numSolicitud",
    ...
    this.solicitudes$ = this.tipoSolicitudesService.getTipos().pipe(tap((response) => {
  ...
  onConsultar() {
    if (this.form.valid) {
      ...
      this.reportesService.getReporteSolicitudes(consulta).pipe(map((response) => {
  ...
  exportToExcel(data) {
    ...
    dialog.afterClosed().subscribe((response) => {
      if (response === "confirmed") {
        ...
        writeFileSync(workbook, `Reporte de solicitudes${this.datePipe.transform(/* @__PURE__ */ new Date(), "dd/MM/yyyy")}.xlsx`);
      }
    });
  }
  createForm() {
...
_ReporteSolicitudesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReporteSolicitudesComponent, selectors: [["app-reporte-solicitudes"]], standalone: true, features: [\u0275\u0275ProvidersFeature([
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("selectionChange", function ReporteSolicitudesComponent_Template_mat_select_selectionChange_13_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onSelect($event));
    });
    \u0275\u0275template(14, ReporteSolicitudesComponent_ng_container_14_Template, 2, 1, "ng-container", 13);
    \u0275\u0275pipe(15, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function ReporteSolicitudesComponent_Template_button_click_30_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function ReporteSolicitudesComponent_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(35, " Exportar ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(36, ReporteSolicitudesComponent_Conditional_36_Template, 3, 5, "div", 19)(37, ReporteSolicitudesComponent_Conditional_37_Template, 6, 2, "div", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(15, 18, ctx.solicitudes$));
    \u0275\u0275advance(5);
...
var ReporteSolicitudesComponent = _ReporteSolicitudesComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReporteSolicitudesComponent, { className: "ReporteSolicitudesComponent", filePath: "src\\app\\pages\\reportes\\reporte-solicitudes\\reporte-solicitudes\\reporte-solicitudes.component.ts", lineNumber: 59 });
})();

// src/app/pages/reportes/reporte-solicitudes/reporte-solicitudes.routes.ts
var reporte_solicitudes_routes_default = [
  {
    path: "",
...
export {
  reporte_solicitudes_routes_default as default
};
//# sourceMappingURL=chunk-CFVUW362.js.map
