...
// src/app/core/services/toast-alerts.service.ts
var _ToastAlertsService = class _ToastAlertsService {
  constructor(snackBar) {
    this.snackBar = snackBar;
  }
  toasAlertWarn(optionAlert) {
...
_ToastAlertsService.\u0275fac = function ToastAlertsService_Factory(t) {
  return new (t || _ToastAlertsService)(\u0275\u0275inject(MatSnackBar));
};
_ToastAlertsService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ToastAlertsService, factory: _ToastAlertsService.\u0275fac, providedIn: "root" });
var ToastAlertsService = _ToastAlertsService;

export {
  ToastAlertsService
};
//# sourceMappingURL=chunk-N5WAY7KO.js.map
