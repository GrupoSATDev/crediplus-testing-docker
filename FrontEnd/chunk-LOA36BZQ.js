...
var _ErrorHandlerService = class _ErrorHandlerService {
  ...
  errorHandler(error) {
    ...
    const errorMessage = (0, import_lodash.isArray)(error.error?.errorMenssages) && error.error?.errorMenssages[0] ? error.error.errorMenssages[0] : error.errors || "Ocurri\xF3 un error inesperado";
...
_ErrorHandlerService.\u0275fac = function ErrorHandlerService_Factory(t) {
  return new (t || _ErrorHandlerService)(\u0275\u0275inject(SwalService));
};
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LOA36BZQ.js.map
