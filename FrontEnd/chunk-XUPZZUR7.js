...
var _AuthSignUpComponent = class _AuthSignUpComponent {
  /**
   * Constructor
   */
...
_AuthSignUpComponent.\u0275fac = function AuthSignUpComponent_Factory(t) {
  return new (t || _AuthSignUpComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(UntypedFormBuilder), \u0275\u0275directiveInject(Router));
};
_AuthSignUpComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthSignUpComponent, selectors: [["auth-sign-up"]], viewQuery: function AuthSignUpComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c0, 5);
  }
  if (rf & 2) {
...
var AuthSignUpComponent = _AuthSignUpComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthSignUpComponent, { className: "AuthSignUpComponent", filePath: "src\\app\\modules\\auth\\sign-up\\sign-up.component.ts", lineNumber: 40 });
})();
...
//# sourceMappingURL=chunk-XUPZZUR7.js.map
