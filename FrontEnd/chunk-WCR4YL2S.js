...
var _SwalService = class _SwalService {
  ToastAler({ icon, title, text = "", html = "", timer = 1e3 }) {
  ...
  showConfirm(title, text, icon = "warning") {
  ...
  showAutoCloseAlert(title, text, timer = 3e3) {
    import_sweetalert2.default.fire({
      title,
      text,
      timer,
...
_SwalService.\u0275fac = function SwalService_Factory(t) {
  return new (t || _SwalService)();
};
_SwalService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SwalService, factory: _SwalService.\u0275fac, providedIn: "root" });
var SwalService = _SwalService;
...
sweetalert2/dist/sweetalert2.all.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-WCR4YL2S.js.map
